...
<BODY>
    ...
    width: 1304px;    margin: 50px auto;    margin-left: -330px;    height: 500px;">
            <div style="margin-left:746px;     margin-top: 45px;">
                <div class="inline-block">
                    ...
                    while ($row = mysqli_fetch_array($sql)) { 
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <input class="input-box-330" type="text" value="<?= $row['username']; ?>" name="username" id="username">
                </div> <br>
                ...
                <div class="inline-block">
                    ...
                    <input class="input-box-330" type="text" value="<?= $row['contact']; ?>" name="contact" id="username">
                </div><br>
                <div class="inline-block">
                    <div class="form-label">
                        Address<span class="required error" id="username-info"></span>
                    </div>
                    <input class="input-box-330" value="<?= $row['address']; ?>" type="text" name="address" id="username">
                </div><br>
                <div class="inline-block">
                    <div class="form-label">
                ...
                <div class="inline-block">
                    ...
                    <input class="input-box-330" value="<?= $row['state']; ?>" type="text" name="state" id="username">
                ...
                <div class="inline-block">
                    ...
                    <input class="input-box-330" type="file" name="file" id="username">
                </div><br><input class="input-box-330" type="hidden" value="<?= $row['email']; ?>" name="email"><br>
    ...
    margin-left: -328px;    border-radius: 106px;    margin-top: -318px;">
            ...
            <div class="row" style="margin-left: -308px;">
                <input class="btn" type="submit" name="submit" id="login-btn" value="SAVE "><br>
            </div>
            </div>
            </form>
    ...
    margin-top: -387px;">
                <a href="histroy.php"> <input class="btn" type="submit" name="submit" id="login-btn" value="previous Histroy "></a><br>
            </div>

            <div class="row" style="margin-left: -996px;
    margin-top: 2px;">
                <a href="feedback.php"> <input class="btn" type="submit" name="submit" id="login-btn" value="Give Feedback"></a><br><br>
                
                <a href="logout.php"> <input class="btn" type="submit" name="submit" id="login-btn" value="Logout "></a><br>
            </div>
